...
function ComparisonRow({
    ...
    return (
        <motion.div
            ...
            className={`flex items-start gap-3 rounded-xl border px-4 py-3.5 sm:gap-4 sm:px-5 sm:py-4 ${isGood
                ? "border-[#E5231B]/40 bg-[#E5231B]/[0.08]"
                : "border-white/10 bg-white/[0.03]"
                }`}
        >
            <span
                className={`mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full border ${isGood ? "border-[#E5231B] text-[#E5231B]" : "border-[#E5231B]/70 text-[#E5231B]/70"
                    }`}
            >
