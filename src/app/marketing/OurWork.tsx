 ...
 * -------------------------------------------------------------------------
 * Drop into: app/components/ClientReel.tsx
 * Deps:      npm i framer-motion lucide-react
 *
 * Place assets in /public/clients/, e.g.:
 *   /public/clients/burger-co-avatar.jpg   /public/clients/burger-co-reel.jpg
 *   /public/clients/fitzone-avatar.jpg     /public/clients/fitzone-reel.jpg
 *   /public/clients/glowskin-avatar.jpg    /public/clients/glowskin-reel.jpg
 *   /public/clients/urbanthreads-avatar.jpg /public/clients/urbanthreads-reel.jpg
 * Update the `clients` array below with your real filenames + Instagram links.
 *
 * The 3D effect: each card tracks the cursor and tilts on X/Y with a
 * spring (perspective + rotateX/rotateY). Inside the card, the avatar
 * pill, play button, and text block sit on separate Z planes
 * (translateZ) so they visually float above the photo as the card
 * tilts — plus a cursor-tracked light glare and a shadow that deepens
 * with the tilt angle to sell the depth.
 */
...
const clients: Client[] = [
    {
        name: "The Burger Co.",
        category: "Restaurant",
        avatar: "/clients/burger-co-avatar.jpg",
        thumbnail: "/clients/burger-co-reel.jpg",
        instagramUrl: "#",
    },
    {
        name: "Fitzone India",
        category: "Fitness",
        avatar: "/clients/fitzone-avatar.jpg",
        thumbnail: "/clients/fitzone-reel.jpg",
        instagramUrl: "#",
    },
    {
        name: "Glow Skin Clinic",
        category: "Skincare",
        avatar: "/clients/glowskin-avatar.jpg",
        thumbnail: "/clients/glowskin-reel.jpg",
        instagramUrl: "#",
    },
    {
        name: "Urban Threads",
        category: "Fashion",
        avatar: "/clients/urbanthreads-avatar.jpg",
        thumbnail: "/clients/urbanthreads-reel.jpg",
        instagramUrl: "#",
    },
];
...
function ClientCard({ client, index }: { client: Client; index: number }) {
    ...
    return (
        <motion.a
            ...
            className="group relative block aspect-[3/4] sm:aspect-[4/5]"
            ...
            >
                ...
                >
                    <motion.img
                        ...
                        alt={`${client.name} Instagram reel`}
                ...
                {/* bottom text block — floats just above the photo */}
                <div
        ...
        <section className="relative overflow-hidden bg-black px-4 py-24 sm:px-6 sm:py-32">
            ...
            >
                <motion.a
                    ...
                    className="rounded-full bg-gradient-to-b from-[#ff3b30] to-[#B3140C] px-8 py-3.5 text-sm font-bold text-white shadow-[0_10px_35px_rgba(229,35,27,0.4)] transition-shadow hover:shadow-[0_14px_45px_rgba(229,35,27,0.6)]"
                >
                    View all work
                </motion.a>
            </motion.div>
